...
function particle_smoke(origin, dir)
	
	shader = cgame.RegisterShader("particles/smoke");
	
	-- spawn particles
	for i = 1, 10, 1 do
		particle_smoke_SpawnSmokeParticle(origin, shader, dir)
	end
end

function particle_smoke_SpawnSmokeParticle(origin, shader, dir)
