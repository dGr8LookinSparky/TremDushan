...
// vmnumber = game.getSelf()
static int game_getSelf( lua_State* L )
{
...
// paramVal = game.getLuaParam(entnum, paramnum)
static int game_GetLuaParam( lua_State* L )
{
    gentity_t*      ent;
    int             entnum;
    int             paramnum;
    ...
    DEBUG_LUA( "game_GetLuaParam: start: ent=%d paramnum=%d", entnum, paramnum );
    ...
    if( ent )
    {
        switch( paramnum )
        {
            case 1:
                ...
                DEBUG_LUA( "game_GetLuaParam: return: param1 value=%s", ent->luaParam1 );
                break;
            case 2:
                lua_pushstring( L, ent->luaParam2 );
                DEBUG_LUA( "game_GetLuaParam: return: param2 value=%s", ent->luaParam2 );
                break;
            case 3:
                lua_pushstring( L, ent->luaParam3 );
                DEBUG_LUA( "game_GetLuaParam: return: param3 value=%s", ent->luaParam3 );
                break;
            case 4:
                lua_pushstring( L, ent->luaParam4 );
                DEBUG_LUA( "game_GetLuaParam: return: param4 value=%s", ent->luaParam4 );
                break;
            default:
                DEBUG_LUA( "game_GetLuaParam: return: invalid paramnum=%d", paramnum );
                return 0;
        }
    }
    return 1;
...
static const luaL_reg gamelib[] =
{
    ...
    // get funcs
    {"getLeveltime", game_Leveltime},
    {"getSelf", game_getSelf},
    {"getLuaParam", game_GetLuaParam},
