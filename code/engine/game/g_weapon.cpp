...
bool CheckGauntletAttack( gentity_t* ent )
{
    ...
    CalcMuzzlePoint( ent, forward, right, up, muzzle, WP_GAUNTLET, false );
...
void FireWeapon( gentity_t* ent )
{
    ...
    {
        // set aiming directions
        CalcMuzzlePoint( ent, forward, right, up, muzzle, ent->s.weapon, false );
    }
    else
    {
...
void FireWeapon2( gentity_t* ent )
{
    ...
    {
        // set aiming directions
        CalcMuzzlePoint( ent, forward, right, up, muzzle, ent->s.weapon, true );
    }
    else
    {
        AngleVectors( ent->s.angles2, forward, right, up );
