...
void SP_target_speaker( gentity_t* ent )
{
    ...
    else if( G_SpawnString( "noise", "NOSOUND", &s ) )
    {
        ...
        ent->soundLooping = ent->spawnflags & 1 ? true : false;
        ent->soundWaitForTrigger = ent->spawnflags & 2 ? true : false;
        ent->soundGlobal = ent->spawnflags & 4 ? true : false;
        ent->soundActivator = ent->spawnflags & 8 ? true : false;
    }
    else
    {
