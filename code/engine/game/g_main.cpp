...
static cvarTable_t gameCvarTable[] =
{
    ...
    // latched vars
    {&g_gametype, "g_gametype", "3", CVAR_SERVERINFO | CVAR_USERINFO | CVAR_LATCH, 0, false},
    ...
    {&g_speed, "g_speed", "400", 0, 0, true},
    
    {&g_gravityX, "g_gravityX", "0", CVAR_SYSTEMINFO, 0, true},
    {&g_gravityY, "g_gravityY", "0", CVAR_SYSTEMINFO, 0, true},
    {&g_gravityZ, "g_gravityZ", DEFAULT_GRAVITY_STRING, CVAR_SYSTEMINFO, 0, true},
    
    {&g_knockback, "g_knockback", "1000", 0, 0, true},
    {&g_knockbackZ, "g_knockbackZ", "40", 0, 0, true},
    {&g_quadfactor, "g_quadfactor", "4", 0, 0, true},
    ...
    {&g_debugLua, "g_debugLua", "0", 0, 0, false},
    ...
    {&g_rocketAcceleration, "g_rocketAcceleration", "0", 0, 0, false},
    {&g_rocketVelocity, "g_rocketVelocity", "900", 0, 0, false},
    
    {&g_smoothClients, "g_smoothClients", "1", 0, 0, false},
    {&g_rankings, "g_rankings", "0", 0, 0, false},
    
    // these cvars are shared accross both games
    {&pm_debugMove, "pm_debugMove", "0", 0, 0, false},
    {&pm_airControl, "pm_airControl", "0", CVAR_SYSTEMINFO, 0, false},
    {&pm_fastWeaponSwitches, "pm_fastWeaponSwitches", "0", CVAR_SYSTEMINFO, 0, false},
    {&pm_fixedPmove, "pm_fixedPmove", "1", CVAR_SYSTEMINFO, 0, false},
    {&pm_fixedPmoveFPS, "pm_fixedPmoveFPS", "125", CVAR_SYSTEMINFO, 0, false},
    
    {&lua_allowedModules, "lua_allowedModules", "", 0, 0, false},
    {&lua_modules, "lua_modules", "", 0, 0, false},
    
#if defined(USE_BULLET)
    {&g_physUseCCD, "g_physUseCCD", "1", 0, 0, false},
#endif
    
#if defined(ACEBOT)
    {&ace_debug, "ace_debug", "0", 0, 0, false},
    {&ace_showNodes, "ace_showNodes", "0", 0, 0, false},
    {&ace_showLinks, "ace_showLinks", "0", 0, 0, false},
    {&ace_showPath, "ace_showPath", "0", 0, 0, false},
    {&ace_pickLongRangeGoal, "ace_pickLongRangeGoal", "1", 0, 0, false},
    {&ace_pickShortRangeGoal, "ace_pickShortRangeGoal", "1", 0, 0, false},
    {&ace_attackEnemies, "ace_attackEnemies", "1", 0, 0, false},
    {&ace_spSkill, "g_spSkill", "3", 0, 0, false},	// FIXME rename
    {&ace_botsFile, "g_botsFile", "3", 0, 0, false},	// FIXME rename
#endif
};
                 ...
                 int arg10, int arg11 )
{
    switch( command )
    {
        ...
        case GAME_CONSOLE_COMMAND:
            ...
            // AI will run alongside the default bots
        case AI_START_FRAME:
            return AI_StartFrame( arg0 );
...
#ifdef G_LUA
    // Lua API callbacks
    // do we need to send print msgs to lua?
...
void G_InitGame( int levelTime, int randomSeed, int restart )
{
    ...
    G_LuaHook_MapStart( map, restart );
}
