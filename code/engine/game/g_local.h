...
struct gentity_s
{
    ...
    void ( *activate )( gentity_t* self, gentity_t* other, bool firstActivate );
    ...
    bool        takedamage;
    bool        crusher;	// doors that squeeze players
    int             damage;
    ...
    bool        suspended;	// item will spawn where it was placed in map and won't drop to the floor
...
struct gclient_s
{
    ...
    bool        hookFireHeld;	// used for hook
...
bool        G_IsVisible( const gentity_t* self, const vec3_t goal );
gentity_t*      G_PickTarget( char* name );
void            G_UseTargets( gentity_t* ent, gentity_t* activator );
void            G_SetMovedir( vec3_t angles, vec3_t movedir );

void            G_ActivateUse( gentity_t* ent, gentity_t* other, bool firstActivate );
void            G_ActivateUseFirst( gentity_t* ent, gentity_t* other, bool firstActivate );
...
bool        G_Damage( gentity_t* targ, gentity_t* inflictor, gentity_t* attacker, const vec3_t dir, const vec3_t point, int damage,
                      int dflags, int mod );
...
void            SetupTrainPath( gentity_t* ent, bool allowNoTarget );
...
void            CalcMuzzlePoint( gentity_t* ent, vec3_t forward, vec3_t right, vec3_t up, vec3_t muzzlePoint, int weapon, bool secondary );
