...
bool        ACEAI_FindEnemy( gentity_t* self );
void            ACEAI_ChooseWeapon( gentity_t* self );

// acebot_cmds.c protos
bool        ACECM_Commands( gentity_t* ent );
void            ACECM_Store();

// acebot_items.c protos
void            ACEIT_PlayerAdded( gentity_t* ent );
void            ACEIT_PlayerRemoved( gentity_t* ent );
bool        ACEIT_IsVisible( gentity_t* self, vec3_t goal );
bool        ACEIT_IsReachable( gentity_t* self, vec3_t goal );
bool        ACEIT_ChangeWeapon( gentity_t* ent, weapon_t weapon );
float           ACEIT_ItemNeed( gentity_t* self, gentity_t* itemEnt );
void            ACEIT_BuildItemNodeTable( bool rebuild );

// acebot_movement.c protos
bool        ACEMV_SpecialMove( gentity_t* self );
...
bool        ACEND_FollowPath( gentity_t* self );
void            ACEND_GrapFired( gentity_t* self );
bool        ACEND_CheckForLadder( gentity_t* self );
...
void            ACESP_InitBots( bool restart );
void            ACESP_HoldSpawn( gentity_t* self );
void            ACESP_PutClientInServer( gentity_t* bot, bool respawn, int team );
...
bool        ACESP_BotConnect( int clientNum, bool restart );
