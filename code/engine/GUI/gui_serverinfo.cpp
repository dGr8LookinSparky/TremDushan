...
void UI_ServerInfoMenu( void )
{
    ...
    s_serverinfo.banner._generic.type = MTYPE_BTEXT;
    s_serverinfo.banner._generic.x = 320;
    s_serverinfo.banner._generic.y = 16;
    ...
    s_serverinfo.add._generic.type = MTYPE_PTEXT;
    s_serverinfo.add._generic.flags = QMF_CENTER_JUSTIFY | QMF_PULSEIFFOCUS;
    s_serverinfo.add._generic.callback = ServerInfo_Event;
    s_serverinfo.add._generic.id = ID_ADD;
    s_serverinfo.add._generic.x = 320;
    s_serverinfo.add._generic.y = 371;
    ...
    {
        s_serverinfo.add._generic.flags |= QMF_GRAYED;
    }
    
    s_serverinfo.back._generic.type = MTYPE_BITMAP;
    s_serverinfo.back._generic.name = UI_ART_BUTTON;
    s_serverinfo.back._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    s_serverinfo.back._generic.callback = ServerInfo_Event;
    s_serverinfo.back._generic.id = ID_BACK;
    s_serverinfo.back._generic.x = 0;
    s_serverinfo.back._generic.y = 480 - 64;
    s_serverinfo.back.width = 128;
    s_serverinfo.back.height = 64;
    s_serverinfo.back.focuspic = UI_ART_BUTTON_FOCUS;
    s_serverinfo.back._generic.caption.text = "back";
    s_serverinfo.back._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    s_serverinfo.back._generic.caption.fontsize = 0.6f;
    s_serverinfo.back._generic.caption.font = &uis.freeSansFont;
    s_serverinfo.back._generic.caption.color = text_color_normal;
    s_serverinfo.back._generic.caption.focuscolor = text_color_highlight;
