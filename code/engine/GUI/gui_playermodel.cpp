...
static void PlayerModel_UpdateGrid( void )
{
    ...
    for( i = 0; i < PLAYERGRID_ROWS * PLAYERGRID_COLS; i++, j++ )
    {
        ...
        {
            // model/skin portrait
            s_playermodel.pics[i]._generic.name = s_playermodel.modelnames[j];
            s_playermodel.picbuttons[i]._generic.flags &= ~QMF_INACTIVE;
        }
        else
        {
            // dead slot
            s_playermodel.pics[i]._generic.name = NULL;
            s_playermodel.picbuttons[i]._generic.flags |= QMF_INACTIVE;
        }
        
        s_playermodel.pics[i]._generic.flags &= ~QMF_HIGHLIGHT;
        s_playermodel.pics[i].shader = 0;
        s_playermodel.picbuttons[i]._generic.flags |= QMF_PULSEIFFOCUS;
    }
    ...
    if( s_playermodel.numpages > 1 )
    {
        if( s_playermodel.modelpage > 0 )
            s_playermodel.left._generic.flags &= ~QMF_INACTIVE;
        else
            s_playermodel.left._generic.flags |= QMF_INACTIVE;
            
        if( s_playermodel.modelpage < s_playermodel.numpages - 1 )
            s_playermodel.right._generic.flags &= ~QMF_INACTIVE;
        else
            s_playermodel.right._generic.flags |= QMF_INACTIVE;
    }
    else
...
static void PlayerModel_DrawPlayer( void* self )
{
    ...
    if( trap_MemoryRemaining() <= LOW_MEMORY )
    {
        UI_DrawProportionalString( b->_generic.x, b->_generic.y + b->height / 2, "LOW MEMORY", UI_LEFT, color_red );
        return;
    }
    
    
    UI_DrawPlayer( b->_generic.x, b->_generic.y, b->width, b->height, &s_playermodel.playerinfo, uis.realtime / 2 );
}
...
static void PlayerModel_MenuInit( void )
{
    ...
    s_playermodel.banner._generic.type = MTYPE_BTEXT;
    s_playermodel.banner._generic.x = 320;
    s_playermodel.banner._generic.y = 16;
    ...
    /*	s_playermodel.framel._generic.type = MTYPE_BITMAP;
    	s_playermodel.framel._generic.name = MODEL_FRAMEL;
    	s_playermodel.framel._generic.flags = QMF_LEFT_JUSTIFY | QMF_INACTIVE;
    	s_playermodel.framel._generic.x = 0;
    	s_playermodel.framel._generic.y = 78;
    	s_playermodel.framel.width = 256;
    	s_playermodel.framel.height = 329;
    
    	s_playermodel.framer._generic.type = MTYPE_BITMAP;
    	s_playermodel.framer._generic.name = MODEL_FRAMER;
    	s_playermodel.framer._generic.flags = QMF_LEFT_JUSTIFY | QMF_INACTIVE;
    	s_playermodel.framer._generic.x = 376;
    	s_playermodel.framer._generic.y = 76;
    	s_playermodel.framer.width = 256;
    	s_playermodel.framer.height = 334;
    */
    /*	s_playermodel.ports._generic.type = MTYPE_BITMAP;
    	s_playermodel.ports._generic.name = MODEL_PORTS;
    	s_playermodel.ports._generic.flags = QMF_LEFT_JUSTIFY | QMF_INACTIVE;
    	s_playermodel.ports._generic.x = 50;
    	s_playermodel.ports._generic.y = 59;
    ...
    */
    ...
    for( i = 0, k = 0; i < PLAYERGRID_ROWS; i++ )
    {
        ...
        {
            s_playermodel.pics[k]._generic.type = MTYPE_BITMAP;
            s_playermodel.pics[k]._generic.flags = QMF_LEFT_JUSTIFY | QMF_INACTIVE;
            s_playermodel.pics[k]._generic.x = x;
            s_playermodel.pics[k]._generic.y = y;
            ...
            s_playermodel.picbuttons[k]._generic.type = MTYPE_BITMAP;
            s_playermodel.picbuttons[k]._generic.flags = QMF_LEFT_JUSTIFY | QMF_NODEFAULTINIT | QMF_PULSEIFFOCUS;
            s_playermodel.picbuttons[k]._generic.id = ID_PLAYERPIC0 + k;
            s_playermodel.picbuttons[k]._generic.callback = PlayerModel_PicEvent;
            s_playermodel.picbuttons[k]._generic.x = x;
            s_playermodel.picbuttons[k]._generic.y = y;
            s_playermodel.picbuttons[k]._generic.left = x;
            s_playermodel.picbuttons[k]._generic.top = y;
            s_playermodel.picbuttons[k]._generic.right = x + 64;
            s_playermodel.picbuttons[k]._generic.bottom = y + 64;
    ...
    s_playermodel.playername._generic.type = MTYPE_TEXT;
    s_playermodel.playername._generic.flags = QMF_CENTER_JUSTIFY | QMF_INACTIVE;
    s_playermodel.playername._generic.x = 320;
    s_playermodel.playername._generic.y = 440;
    ...
    s_playermodel.modelname._generic.type = MTYPE_TEXT;
    s_playermodel.modelname._generic.flags = QMF_CENTER_JUSTIFY | QMF_INACTIVE;
    s_playermodel.modelname._generic.x = 280;
    s_playermodel.modelname._generic.y = y;
    ...
    s_playermodel.skinname._generic.type = MTYPE_TEXT;
    s_playermodel.skinname._generic.flags = QMF_CENTER_JUSTIFY | QMF_INACTIVE;
    s_playermodel.skinname._generic.x = 280;
    s_playermodel.skinname._generic.y = y;
...
//TODO: add some effects, maybe some "fake" info ?
    ...
    s_playermodel.player._generic.type = MTYPE_BITMAP;
    s_playermodel.player._generic.flags = QMF_INACTIVE;
    s_playermodel.player._generic.ownerdraw = PlayerModel_DrawPlayer;
    s_playermodel.player._generic.x = 270;
    s_playermodel.player._generic.y = -75;
    s_playermodel.player.width = 32 * 13;
    s_playermodel.player.height = 56 * 13;
    
    
    
    s_playermodel.arrows._generic.type = MTYPE_BITMAP;
    s_playermodel.arrows._generic.name = MODEL_ARROWS;
    s_playermodel.arrows._generic.flags = QMF_INACTIVE;
    s_playermodel.arrows._generic.x = 125 - 64;
    s_playermodel.arrows._generic.y = 340 + 41;
    s_playermodel.arrows.width = 128;
    s_playermodel.arrows.height = 32;
    
    s_playermodel.left._generic.type = MTYPE_BITMAP;
    s_playermodel.left._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    s_playermodel.left._generic.callback = PlayerModel_MenuEvent;
    s_playermodel.left._generic.id = ID_PREVPAGE;
    s_playermodel.left._generic.x = 125 - 64;
    s_playermodel.left._generic.y = 340 + 41;
    s_playermodel.left.width = 64;
    s_playermodel.left.height = 32;
    s_playermodel.left.focuspic = MODEL_ARROWSL;
    
    s_playermodel.right._generic.type = MTYPE_BITMAP;
    s_playermodel.right._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    s_playermodel.right._generic.callback = PlayerModel_MenuEvent;
    s_playermodel.right._generic.id = ID_NEXTPAGE;
    s_playermodel.right._generic.x = 125 + 61 - 64;
    s_playermodel.right._generic.y = 340 + 41;
    s_playermodel.right.width = 64;
    s_playermodel.right.height = 32;
    s_playermodel.right.focuspic = MODEL_ARROWSR;
    
    s_playermodel.back._generic.type = MTYPE_BITMAP;
    s_playermodel.back._generic.name = UI_ART_BUTTON;
    s_playermodel.back._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    s_playermodel.back._generic.callback = PlayerModel_MenuEvent;
    s_playermodel.back._generic.id = ID_BACK;
    s_playermodel.back._generic.x = 0;
    s_playermodel.back._generic.y = 480 - 64;
    s_playermodel.back.width = 128;
    s_playermodel.back.height = 64;
    s_playermodel.back.focuspic = UI_ART_BUTTON_FOCUS;
    s_playermodel.back._generic.caption.text = "back";
    s_playermodel.back._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    s_playermodel.back._generic.caption.fontsize = 0.6f;
    s_playermodel.back._generic.caption.font = &uis.freeSansFont;
    s_playermodel.back._generic.caption.color = text_color_normal;
    s_playermodel.back._generic.caption.focuscolor = text_color_highlight;
