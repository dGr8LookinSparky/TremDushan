...
static void UI_SPLevelMenu_SetMenuArena( int n, int level, const char* arenaInfo )
{
    ...
    if( selectedArenaSet > currentSet )
    {
        levelMenuInfo.item_maps[n]._generic.flags |= QMF_GRAYED;
    }
    else
    {
        levelMenuInfo.item_maps[n]._generic.flags &= ~QMF_GRAYED;
    ...
    levelMenuInfo.item_maps[n]._generic.flags &= ~QMF_INACTIVE;
}
...
static void UI_SPLevelMenu_SetMenuItems( void )
{
    ...
    if( selectedArenaSet == trainingTier )
    {
        ...
        levelMenuInfo.item_maps[0]._generic.x = 256;
        Bitmap_Init( &levelMenuInfo.item_maps[0] );
        levelMenuInfo.item_maps[0]._generic.bottom += 32;
        levelMenuInfo.numMaps = 1;
        
        levelMenuInfo.item_maps[1]._generic.flags |= QMF_INACTIVE;
        levelMenuInfo.item_maps[2]._generic.flags |= QMF_INACTIVE;
        levelMenuInfo.item_maps[3]._generic.flags |= QMF_INACTIVE;
    ...
    {
        levelMenuInfo.item_maps[0]._generic.x = 46;
        Bitmap_Init( &levelMenuInfo.item_maps[0] );
        levelMenuInfo.item_maps[0]._generic.bottom += 18;
    ...
    {
        levelMenuInfo.item_leftarrow._generic.flags |= ( QMF_INACTIVE | QMF_HIDDEN );
    }
    else
    {
        levelMenuInfo.item_leftarrow._generic.flags &= ~( QMF_INACTIVE | QMF_HIDDEN );
    ...
    {
        levelMenuInfo.item_rightarrow._generic.flags |= ( QMF_INACTIVE | QMF_HIDDEN );
    }
    else
    {
        levelMenuInfo.item_rightarrow._generic.flags &= ~( QMF_INACTIVE | QMF_HIDDEN );
...
//  int             fraglimit;
    ...
    {
        x = levelMenuInfo.item_maps[n]._generic.x;
        y = levelMenuInfo.item_maps[n]._generic.y;
...
//  UI_DrawString( 18, 212, va("Frags %i", fraglimit) , UI_LEFT|UI_SMALLFONT, color_orange );
    ...
    for( n = 0; n < levelMenuInfo.numBots; n++ )
    {
        ...
        else
        {
            ...
            UI_Text_Paint( x + 32, y + 24 + 8, 0.5f, text_color_normal, "?", 0, 0, UI_CENTER | UI_DROPSHADOW, &uis.freeSansFont );
...
static void UI_SPLevelMenu_Init( void )
{
    ...
    levelMenuInfo.item_banner._generic.type = MTYPE_BTEXT;
    levelMenuInfo.item_banner._generic.x = 320;
    levelMenuInfo.item_banner._generic.y = 16;
    ...
    levelMenuInfo.item_leftarrow._generic.type = MTYPE_BITMAP;
    levelMenuInfo.item_leftarrow._generic.name = ART_ARROW;
    levelMenuInfo.item_leftarrow._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    levelMenuInfo.item_leftarrow._generic.x = 18;
    levelMenuInfo.item_leftarrow._generic.y = 64;
    levelMenuInfo.item_leftarrow._generic.callback = UI_SPLevelMenu_LeftArrowEvent;
    levelMenuInfo.item_leftarrow._generic.id = ID_LEFTARROW;
    ...
    levelMenuInfo.item_maps[0]._generic.type = MTYPE_BITMAP;
    levelMenuInfo.item_maps[0]._generic.name = levelMenuInfo.levelPicNames[0];
    levelMenuInfo.item_maps[0]._generic.flags = QMF_LEFT_JUSTIFY;
    levelMenuInfo.item_maps[0]._generic.x = 46;
    levelMenuInfo.item_maps[0]._generic.y = 64;
    levelMenuInfo.item_maps[0]._generic.id = ID_PICTURE0;
    levelMenuInfo.item_maps[0]._generic.callback = UI_SPLevelMenu_LevelEvent;
    levelMenuInfo.item_maps[0].width = 128;
    levelMenuInfo.item_maps[0].height = 96;
    
    levelMenuInfo.item_maps[1]._generic.type = MTYPE_BITMAP;
    levelMenuInfo.item_maps[1]._generic.name = levelMenuInfo.levelPicNames[1];
    levelMenuInfo.item_maps[1]._generic.flags = QMF_LEFT_JUSTIFY;
    levelMenuInfo.item_maps[1]._generic.x = 186;
    levelMenuInfo.item_maps[1]._generic.y = 64;
    levelMenuInfo.item_maps[1]._generic.id = ID_PICTURE1;
    levelMenuInfo.item_maps[1]._generic.callback = UI_SPLevelMenu_LevelEvent;
    levelMenuInfo.item_maps[1].width = 128;
    levelMenuInfo.item_maps[1].height = 96;
    
    levelMenuInfo.item_maps[2]._generic.type = MTYPE_BITMAP;
    levelMenuInfo.item_maps[2]._generic.name = levelMenuInfo.levelPicNames[2];
    levelMenuInfo.item_maps[2]._generic.flags = QMF_LEFT_JUSTIFY;
    levelMenuInfo.item_maps[2]._generic.x = 326;
    levelMenuInfo.item_maps[2]._generic.y = 64;
    levelMenuInfo.item_maps[2]._generic.id = ID_PICTURE2;
    levelMenuInfo.item_maps[2]._generic.callback = UI_SPLevelMenu_LevelEvent;
    levelMenuInfo.item_maps[2].width = 128;
    levelMenuInfo.item_maps[2].height = 96;
    
    levelMenuInfo.item_maps[3]._generic.type = MTYPE_BITMAP;
    levelMenuInfo.item_maps[3]._generic.name = levelMenuInfo.levelPicNames[3];
    levelMenuInfo.item_maps[3]._generic.flags = QMF_LEFT_JUSTIFY;
    levelMenuInfo.item_maps[3]._generic.x = 466;
    levelMenuInfo.item_maps[3]._generic.y = 64;
    levelMenuInfo.item_maps[3]._generic.id = ID_PICTURE3;
    levelMenuInfo.item_maps[3]._generic.callback = UI_SPLevelMenu_LevelEvent;
    levelMenuInfo.item_maps[3].width = 128;
    levelMenuInfo.item_maps[3].height = 96;
    
    levelMenuInfo.item_rightarrow._generic.type = MTYPE_BITMAP;
    levelMenuInfo.item_rightarrow._generic.name = ART_ARROW;
    levelMenuInfo.item_rightarrow._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    levelMenuInfo.item_rightarrow._generic.x = 606;
    levelMenuInfo.item_rightarrow._generic.y = 64;
    levelMenuInfo.item_rightarrow._generic.callback = UI_SPLevelMenu_RightArrowEvent;
    levelMenuInfo.item_rightarrow._generic.id = ID_RIGHTARROW;
    ...
    PlayerIcon( levelMenuInfo.playerModel, levelMenuInfo.playerPicName, sizeof( levelMenuInfo.playerPicName ) );
    levelMenuInfo.item_player._generic.type = MTYPE_BITMAP;
    levelMenuInfo.item_player._generic.name = levelMenuInfo.playerPicName;
    levelMenuInfo.item_player._generic.flags = QMF_LEFT_JUSTIFY | QMF_MOUSEONLY;
    levelMenuInfo.item_player._generic.x = 288;
    levelMenuInfo.item_player._generic.y = AWARDS_Y;
    levelMenuInfo.item_player._generic.id = ID_PLAYERPIC;
    levelMenuInfo.item_player._generic.callback = UI_SPLevelMenu_PlayerEvent;
    ...
    for( n = 0; n < 6; n++ )
    {
        if( levelMenuInfo.awardLevels[n] )
        {
            ...
            levelMenuInfo.item_awards[count]._generic.type = MTYPE_BITMAP;
            levelMenuInfo.item_awards[count]._generic.name = ui_medalPicNames[n];
            levelMenuInfo.item_awards[count]._generic.flags = QMF_LEFT_JUSTIFY | QMF_SILENT | QMF_MOUSEONLY;
            levelMenuInfo.item_awards[count]._generic.x = x;
            levelMenuInfo.item_awards[count]._generic.y = y;
            levelMenuInfo.item_awards[count]._generic.id = ID_AWARD1 + n;
            levelMenuInfo.item_awards[count]._generic.callback = UI_SPLevelMenu_AwardEvent;
    ...
    levelMenuInfo.item_back._generic.type = MTYPE_BITMAP;
    levelMenuInfo.item_back._generic.name = UI_ART_BUTTON;
    levelMenuInfo.item_back._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    levelMenuInfo.item_back._generic.x = 0;
    levelMenuInfo.item_back._generic.y = 480 - 64;
    levelMenuInfo.item_back._generic.callback = UI_SPLevelMenu_BackEvent;
    levelMenuInfo.item_back._generic.id = ID_BACK;
    levelMenuInfo.item_back.width = 128;
    levelMenuInfo.item_back.height = 64;
    levelMenuInfo.item_back.focuspic = UI_ART_BUTTON_FOCUS;
    levelMenuInfo.item_back._generic.caption.text = "back";
    levelMenuInfo.item_back._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    levelMenuInfo.item_back._generic.caption.fontsize = 0.6f;
    levelMenuInfo.item_back._generic.caption.font = &uis.freeSansFont;
    levelMenuInfo.item_back._generic.caption.color = text_color_normal;
    levelMenuInfo.item_back._generic.caption.focuscolor = text_color_highlight;
    
    levelMenuInfo.item_reset._generic.type = MTYPE_BITMAP;
    levelMenuInfo.item_reset._generic.name = UI_ART_BUTTON;
    levelMenuInfo.item_reset._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    levelMenuInfo.item_reset._generic.x = 170;
    levelMenuInfo.item_reset._generic.y = 480 - 64;
    levelMenuInfo.item_reset._generic.callback = UI_SPLevelMenu_ResetEvent;
    levelMenuInfo.item_reset._generic.id = ID_RESET;
    ...
    levelMenuInfo.item_reset._generic.caption.text = "reset";
    levelMenuInfo.item_reset._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    levelMenuInfo.item_reset._generic.caption.fontsize = 0.6f;
    levelMenuInfo.item_reset._generic.caption.font = &uis.freeSansFont;
    levelMenuInfo.item_reset._generic.caption.color = text_color_normal;
    levelMenuInfo.item_reset._generic.caption.focuscolor = text_color_highlight;
    
    levelMenuInfo.item_custom._generic.type = MTYPE_BITMAP;
    levelMenuInfo.item_custom._generic.name = UI_ART_BUTTON;
    levelMenuInfo.item_custom._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    levelMenuInfo.item_custom._generic.x = 342;
    levelMenuInfo.item_custom._generic.y = 480 - 64;
    levelMenuInfo.item_custom._generic.callback = UI_SPLevelMenu_CustomEvent;
    levelMenuInfo.item_custom._generic.id = ID_CUSTOM;
    ...
    levelMenuInfo.item_custom._generic.caption.text = "custom";
    levelMenuInfo.item_custom._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    levelMenuInfo.item_custom._generic.caption.fontsize = 0.6f;
    levelMenuInfo.item_custom._generic.caption.font = &uis.freeSansFont;
    levelMenuInfo.item_custom._generic.caption.color = text_color_normal;
    levelMenuInfo.item_custom._generic.caption.focuscolor = text_color_highlight;
    
    levelMenuInfo.item_next._generic.type = MTYPE_BITMAP;
    levelMenuInfo.item_next._generic.name = UI_ART_BUTTON;
    levelMenuInfo.item_next._generic.flags = QMF_RIGHT_JUSTIFY | QMF_PULSEIFFOCUS;
    levelMenuInfo.item_next._generic.x = 640;
    levelMenuInfo.item_next._generic.y = 480 - 64;
    levelMenuInfo.item_next._generic.callback = UI_SPLevelMenu_NextEvent;
    levelMenuInfo.item_next._generic.id = ID_NEXT;
    levelMenuInfo.item_next.width = 128;
    levelMenuInfo.item_next.height = 64;
    levelMenuInfo.item_next.focuspic = UI_ART_BUTTON_FOCUS;
    levelMenuInfo.item_next._generic.caption.text = "go";
    levelMenuInfo.item_next._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    levelMenuInfo.item_next._generic.caption.fontsize = 0.6f;
    levelMenuInfo.item_next._generic.caption.font = &uis.freeSansFont;
    levelMenuInfo.item_next._generic.caption.color = text_color_normal;
    levelMenuInfo.item_next._generic.caption.focuscolor = text_color_highlight;
    
    levelMenuInfo.item_null._generic.type = MTYPE_BITMAP;
    levelMenuInfo.item_null._generic.flags = QMF_LEFT_JUSTIFY | QMF_MOUSEONLY | QMF_SILENT;
    levelMenuInfo.item_null._generic.x = 0;
    levelMenuInfo.item_null._generic.y = 0;
    ...
    levelMenuInfo.item_maps[0]._generic.bottom += 18;
    levelMenuInfo.item_maps[1]._generic.bottom += 18;
    levelMenuInfo.item_maps[2]._generic.bottom += 18;
    levelMenuInfo.item_maps[3]._generic.bottom += 18;
