...
static void UI_SPPostgameMenu_MenuDraw( void )
{
    ...
    {
        UI_Text_Paint( 510, 480 - 64, 0.25f, colorWhite, postgameMenuInfo.placeNames[2], 0, 0, UI_CENTER | UI_DROPSHADOW, &uis.freeSansFont );
        //UI_DrawProportionalString(510,  - PROP_HEIGHT, postgameMenuInfo.placeNames[2], UI_CENTER, color_white);
    }
    
    UI_Text_Paint( 130, 480 - 64, 0.25f, colorWhite, postgameMenuInfo.placeNames[1], 0, 0, UI_CENTER | UI_DROPSHADOW, &uis.freeSansFont );
    //UI_DrawProportionalString(130, 480 - 64 - PROP_HEIGHT, postgameMenuInfo.placeNames[1], UI_CENTER, color_white);
    
    UI_Text_Paint( 320, 480 - 64, 0.25f, colorWhite, postgameMenuInfo.placeNames[0], 0, 0, UI_CENTER | UI_DROPSHADOW, &uis.freeSansFont );
    ...
    if( postgameMenuInfo.phase == 3 )
    {
        ...
        postgameMenuInfo.item_again._generic.flags &= ~QMF_INACTIVE;
        postgameMenuInfo.item_next._generic.flags &= ~QMF_INACTIVE;
        postgameMenuInfo.item_menu._generic.flags &= ~QMF_INACTIVE;
...
=================
*/
static void UI_SPPostgameMenu_Init( bool playerWon )
{
    ...
    postgameMenuInfo.item_status._generic.type = MTYPE_PTEXT;
//	postgameMenuInfo.item_status._generic.name = UI_ART_BUTTON;
    postgameMenuInfo.item_status._generic.flags = QMF_CENTER_JUSTIFY | QMF_PULSEIFFOCUS | QMF_INACTIVE;
    postgameMenuInfo.item_status._generic.x = 320;
    postgameMenuInfo.item_status._generic.y = 240;
    postgameMenuInfo.item_status._generic.id = ID_STATUS;
...
//	postgameMenuInfo.item_status.focuspic = UI_ART_BUTTON_FOCUS;
    ...
    postgameMenuInfo.item_menu._generic.type = MTYPE_BITMAP;
    postgameMenuInfo.item_menu._generic.name = UI_ART_BUTTON;
    postgameMenuInfo.item_menu._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS | QMF_INACTIVE;
    postgameMenuInfo.item_menu._generic.x = 0;
    postgameMenuInfo.item_menu._generic.y = 480 - 64;
    postgameMenuInfo.item_menu._generic.callback = UI_SPPostgameMenu_MenuEvent;
    postgameMenuInfo.item_menu._generic.id = ID_MENU;
    ...
    postgameMenuInfo.item_menu._generic.caption.text = "menu";
    postgameMenuInfo.item_menu._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    postgameMenuInfo.item_menu._generic.caption.fontsize = 0.6f;
    postgameMenuInfo.item_menu._generic.caption.font = &uis.freeSansFont;
    postgameMenuInfo.item_menu._generic.caption.color = text_color_normal;
    postgameMenuInfo.item_menu._generic.caption.focuscolor = text_color_highlight;
    
    postgameMenuInfo.item_again._generic.type = MTYPE_BITMAP;
    postgameMenuInfo.item_again._generic.name = UI_ART_BUTTON;
    postgameMenuInfo.item_again._generic.flags = QMF_CENTER_JUSTIFY | QMF_PULSEIFFOCUS | QMF_INACTIVE;
    postgameMenuInfo.item_again._generic.x = 320;
    postgameMenuInfo.item_again._generic.y = 480 - 64;
    postgameMenuInfo.item_again._generic.callback = UI_SPPostgameMenu_AgainEvent;
    postgameMenuInfo.item_again._generic.id = ID_AGAIN;
    ...
    postgameMenuInfo.item_again._generic.caption.text = "replay";
    postgameMenuInfo.item_again._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    postgameMenuInfo.item_again._generic.caption.fontsize = 0.6f;
    postgameMenuInfo.item_again._generic.caption.font = &uis.freeSansFont;
    postgameMenuInfo.item_again._generic.caption.color = text_color_normal;
    postgameMenuInfo.item_again._generic.caption.focuscolor = text_color_highlight;
    
    postgameMenuInfo.item_next._generic.type = MTYPE_BITMAP;
    postgameMenuInfo.item_next._generic.name = UI_ART_BUTTON;
    postgameMenuInfo.item_next._generic.flags = QMF_RIGHT_JUSTIFY | QMF_PULSEIFFOCUS | QMF_INACTIVE;
    postgameMenuInfo.item_next._generic.x = 640;
    postgameMenuInfo.item_next._generic.y = 480 - 64;
    postgameMenuInfo.item_next._generic.callback = UI_SPPostgameMenu_NextEvent;
    postgameMenuInfo.item_next._generic.id = ID_NEXT;
    ...
    postgameMenuInfo.item_next._generic.caption.text = "next";
    postgameMenuInfo.item_next._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    postgameMenuInfo.item_next._generic.caption.fontsize = 0.6f;
    postgameMenuInfo.item_next._generic.caption.font = &uis.freeSansFont;
    postgameMenuInfo.item_next._generic.caption.color = text_color_normal;
    postgameMenuInfo.item_next._generic.caption.focuscolor = text_color_highlight;
...
void UI_SPPostgameMenu_f( void )
{
    ...
    playerWon = ( bool ) atoi( UI_Argv( 10 ) );
