...
static void UI_SPSkillMenu_Init( void )
{
    ...
    skillMenuInfo.art_banner._generic.type = MTYPE_BTEXT;
    skillMenuInfo.art_banner._generic.flags = QMF_CENTER_JUSTIFY;
    skillMenuInfo.art_banner._generic.x = 320;
    skillMenuInfo.art_banner._generic.y = 16;
    ...
    skillMenuInfo.item_baby._generic.type = MTYPE_PTEXT;
    skillMenuInfo.item_baby._generic.flags = QMF_CENTER_JUSTIFY | QMF_PULSEIFFOCUS;
    skillMenuInfo.item_baby._generic.x = 320;
    skillMenuInfo.item_baby._generic.y = 170;
    skillMenuInfo.item_baby._generic.callback = UI_SPSkillMenu_SkillEvent;
    skillMenuInfo.item_baby._generic.id = ID_BABY;
    ...
    skillMenuInfo.item_easy._generic.type = MTYPE_PTEXT;
    skillMenuInfo.item_easy._generic.flags = QMF_CENTER_JUSTIFY | QMF_PULSEIFFOCUS;
    skillMenuInfo.item_easy._generic.x = 320;
    skillMenuInfo.item_easy._generic.y = 198;
    skillMenuInfo.item_easy._generic.callback = UI_SPSkillMenu_SkillEvent;
    skillMenuInfo.item_easy._generic.id = ID_EASY;
    ...
    skillMenuInfo.item_medium._generic.type = MTYPE_PTEXT;
    skillMenuInfo.item_medium._generic.flags = QMF_CENTER_JUSTIFY | QMF_PULSEIFFOCUS;
    skillMenuInfo.item_medium._generic.x = 320;
    skillMenuInfo.item_medium._generic.y = 227;
    skillMenuInfo.item_medium._generic.callback = UI_SPSkillMenu_SkillEvent;
    skillMenuInfo.item_medium._generic.id = ID_MEDIUM;
    ...
    skillMenuInfo.item_hard._generic.type = MTYPE_PTEXT;
    skillMenuInfo.item_hard._generic.flags = QMF_CENTER_JUSTIFY | QMF_PULSEIFFOCUS;
    skillMenuInfo.item_hard._generic.x = 320;
    skillMenuInfo.item_hard._generic.y = 255;
    skillMenuInfo.item_hard._generic.callback = UI_SPSkillMenu_SkillEvent;
    skillMenuInfo.item_hard._generic.id = ID_HARD;
    ...
    skillMenuInfo.item_nightmare._generic.type = MTYPE_PTEXT;
    skillMenuInfo.item_nightmare._generic.flags = QMF_CENTER_JUSTIFY | QMF_PULSEIFFOCUS;
    skillMenuInfo.item_nightmare._generic.x = 320;
    skillMenuInfo.item_nightmare._generic.y = 283;
    skillMenuInfo.item_nightmare._generic.callback = UI_SPSkillMenu_SkillEvent;
    skillMenuInfo.item_nightmare._generic.id = ID_NIGHTMARE;
    ...
    skillMenuInfo.item_back._generic.type = MTYPE_BITMAP;
    skillMenuInfo.item_back._generic.name = UI_ART_BUTTON;
    skillMenuInfo.item_back._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    skillMenuInfo.item_back._generic.x = 0;
    skillMenuInfo.item_back._generic.y = 480 - 64;
    skillMenuInfo.item_back._generic.callback = UI_SPSkillMenu_BackEvent;
    skillMenuInfo.item_back._generic.id = ID_BACK;
    skillMenuInfo.item_back.width = 128;
    skillMenuInfo.item_back.height = 64;
    skillMenuInfo.item_back.focuspic = UI_ART_BUTTON_FOCUS;
    skillMenuInfo.item_back._generic.caption.text = "back";
    skillMenuInfo.item_back._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    skillMenuInfo.item_back._generic.caption.fontsize = 0.6f;
    skillMenuInfo.item_back._generic.caption.font = &uis.freeSansFont;
    skillMenuInfo.item_back._generic.caption.color = text_color_normal;
    skillMenuInfo.item_back._generic.caption.focuscolor = text_color_highlight;
    
    skillMenuInfo.art_skillPic._generic.type = MTYPE_BITMAP;
    skillMenuInfo.art_skillPic._generic.flags = QMF_LEFT_JUSTIFY | QMF_INACTIVE;
    skillMenuInfo.art_skillPic._generic.x = 320 - 64;
    skillMenuInfo.art_skillPic._generic.y = 368;
    skillMenuInfo.art_skillPic.width = 128;
    skillMenuInfo.art_skillPic.height = 96;
    
    skillMenuInfo.item_fight._generic.type = MTYPE_BITMAP;
    skillMenuInfo.item_fight._generic.name = UI_ART_BUTTON;
    skillMenuInfo.item_fight._generic.flags = QMF_RIGHT_JUSTIFY | QMF_PULSEIFFOCUS;
    skillMenuInfo.item_fight._generic.callback = UI_SPSkillMenu_FightEvent;
    skillMenuInfo.item_fight._generic.id = ID_FIGHT;
    skillMenuInfo.item_fight._generic.x = 640;
    skillMenuInfo.item_fight._generic.y = 480 - 64;
    ...
    skillMenuInfo.item_fight._generic.caption.text = "fight";
    skillMenuInfo.item_fight._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    skillMenuInfo.item_fight._generic.caption.fontsize = 0.6f;
    skillMenuInfo.item_fight._generic.caption.font = &uis.freeSansFont;
    skillMenuInfo.item_fight._generic.caption.color = text_color_normal;
    skillMenuInfo.item_fight._generic.caption.focuscolor = text_color_highlight;
