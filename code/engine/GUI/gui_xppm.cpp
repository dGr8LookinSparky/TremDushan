...
static bool UI_XPPMParseCharacterFile( const char* filename, playerInfo_t* pi )
{
    char*           text_p, *prev;
    int             len;
    int             i;
...
static bool UI_XPPM_RegisterPlayerAnimation( playerInfo_t* pi, const char* modelName, int anim, const char* animName,
...
bool UI_XPPM_RegisterModel( playerInfo_t* pi, const char* modelName, const char* skinName )
{
    int             i;
    ...
    if( pi->bodyModel )
    {
        ...
        if( !UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_IDLE, "idle", true, false, false ) )
        {
        ...
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, BOTH_DEATH1, "die", false, false, false );
        //UI_XPPM_RegisterPlayerAnimation(pi, modelName, BOTH_DEATH2, "die", false, false, false);
        //UI_XPPM_RegisterPlayerAnimation(pi, modelName, BOTH_DEATH3, "die", false, false, false);
        
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, TORSO_GESTURE, "idle", false, false, false );
        
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, TORSO_ATTACK, "attack", false, false, false );
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, TORSO_ATTACK2, "idle", false, false, false );
        
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, TORSO_STAND2, "idle", false, false, false );
        
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_IDLECR, "crouch", true, false, false );
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_WALKCR, "crouch_forward", true, false, true );
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_BACKCR, "crouch_forward", true, true, true );
        
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_WALK, "walk", true, false, true );
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_BACKWALK, "walk_backwards", true, false, true );
        
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_RUN, "run", true, false, true );
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_BACK, "run_backwards", true, true, true );
        
        // FIXME UI_XPPM_RegisterPlayerAnimation(pi, modelName, LEGS_SWIM, "swim", true);
        
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_JUMP, "jump", false, false, false );
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_LAND, "land", false, false, false );
        
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_JUMPB, "jump", false, false, false );	// FIXME ?
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_LANDB, "land", false, false, false );
        
        
        UI_XPPM_RegisterPlayerAnimation( pi, modelName, LEGS_TURN, "step", false, false, false );
...
void UI_XPPM_Player( float x, float y, float w, float h, playerInfo_t* pi, int time )
{
    ...
    if( !trap_R_BuildSkeleton( &body.skeleton, pi->animations[LEGS_IDLE].handle, body.oldframe, body.frame, 1.0 - body.backlerp, false ) )
    {
