...
static void UI_TeamOrdersMenu_SetList( int id )
{
    switch( id )
    {
        default:
        case ID_LIST_BOTS:
            teamOrdersMenuInfo.list._generic.id = id;
    ...
    teamOrdersMenuInfo.list._generic.bottom = teamOrdersMenuInfo.list._generic.top + teamOrdersMenuInfo.list.numitems * PROP_HEIGHT;
}
...
sfxHandle_t UI_TeamOrdersMenu_Key( int key )
{
    ...
    switch( key )
    {
        case K_MOUSE1:
            x = l->_generic.left;
            y = l->_generic.top;
            if( UI_CursorInRect( x, y, l->_generic.right - x, l->_generic.bottom - y ) )
            {
                ...
                {
                    l->_generic.callback( l, QM_ACTIVATED );
...
static void UI_TeamOrdersMenu_Init( void )
{
    ...
    teamOrdersMenuInfo.menu.fullscreen = true;
    teamOrdersMenuInfo.menu.key = UI_TeamOrdersMenu_Key;
    
    UI_TeamOrdersMenu_BuildBotList();
    
    teamOrdersMenuInfo.banner._generic.type = MTYPE_BTEXT;
    teamOrdersMenuInfo.banner._generic.x = 320;
    teamOrdersMenuInfo.banner._generic.y = 16;
    ...
    teamOrdersMenuInfo.frame._generic.type = MTYPE_BITMAP;
    teamOrdersMenuInfo.frame._generic.flags = QMF_INACTIVE;
    teamOrdersMenuInfo.frame._generic.name = ART_FRAME;
    teamOrdersMenuInfo.frame._generic.x = 320 - 233;
    teamOrdersMenuInfo.frame._generic.y = 240 - 166;
    teamOrdersMenuInfo.frame.width = 466;
    teamOrdersMenuInfo.frame.height = 332;
    
    teamOrdersMenuInfo.list._generic.type = MTYPE_SCROLLLIST;
    teamOrdersMenuInfo.list._generic.flags = QMF_PULSEIFFOCUS;
    teamOrdersMenuInfo.list._generic.ownerdraw = UI_TeamOrdersMenu_ListDraw;
    teamOrdersMenuInfo.list._generic.callback = UI_TeamOrdersMenu_ListEvent;
    teamOrdersMenuInfo.list._generic.x = 320 - 64;
    teamOrdersMenuInfo.list._generic.y = 120;
    
    teamOrdersMenuInfo.back._generic.type = MTYPE_BITMAP;
    teamOrdersMenuInfo.back._generic.name = UI_ART_BUTTON;
    teamOrdersMenuInfo.back._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    teamOrdersMenuInfo.back._generic.callback = UI_TeamOrdersMenu_BackEvent;
    teamOrdersMenuInfo.back._generic.x = 0;
    teamOrdersMenuInfo.back._generic.y = 480 - 64;
    teamOrdersMenuInfo.back.width = 128;
    teamOrdersMenuInfo.back.height = 64;
    teamOrdersMenuInfo.back.focuspic = UI_ART_BUTTON_FOCUS;
    teamOrdersMenuInfo.back._generic.caption.text = "back";
    teamOrdersMenuInfo.back._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    teamOrdersMenuInfo.back._generic.caption.fontsize = 0.6f;
    teamOrdersMenuInfo.back._generic.caption.font = &uis.freeSansFont;
    teamOrdersMenuInfo.back._generic.caption.color = text_color_normal;
    teamOrdersMenuInfo.back._generic.caption.focuscolor = text_color_highlight;
    ...
    teamOrdersMenuInfo.list._generic.left = 220;
    teamOrdersMenuInfo.list._generic.top = teamOrdersMenuInfo.list._generic.y;
    teamOrdersMenuInfo.list._generic.right = 420;
