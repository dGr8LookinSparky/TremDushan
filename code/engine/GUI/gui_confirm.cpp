...
//  }
    /*
    	s_confirm.yes._generic.type = MTYPE_PTEXT;
    	s_confirm.yes._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    	s_confirm.yes._generic.callback = ConfirmMenu_Event;
    	s_confirm.yes._generic.id = ID_CONFIRM_YES;
    	s_confirm.yes._generic.x = l1-20;
    	s_confirm.yes._generic.y = 264;
    	s_confirm.yes.string = "YES";
    	s_confirm.yes.color = color_red;
    	s_confirm.yes.style = UI_LEFT;
    
    	s_confirm.no._generic.type = MTYPE_PTEXT;
    	s_confirm.no._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    	s_confirm.no._generic.callback = ConfirmMenu_Event;
    	s_confirm.no._generic.id = ID_CONFIRM_NO;
    	s_confirm.no._generic.x = l3+20;
    	s_confirm.no._generic.y = 264;
    ...
    */
    ...
    s_confirm.yes._generic.type = MTYPE_BITMAP;
    s_confirm.yes._generic.name = UI_ART_BUTTON;
    s_confirm.yes._generic.flags = QMF_PULSEIFFOCUS;
    s_confirm.yes._generic.callback = ConfirmMenu_Event;
    s_confirm.yes._generic.id = ID_CONFIRM_YES;
    s_confirm.yes._generic.x = 320 - 128;
    s_confirm.yes._generic.y = 244;
    s_confirm.yes.width = 128;
    s_confirm.yes.height = 64;
    s_confirm.yes.focuspic = UI_ART_BUTTON_FOCUS;
    s_confirm.yes._generic.caption.text = "YES";
    s_confirm.yes._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    s_confirm.yes._generic.caption.fontsize = 0.6f;
    s_confirm.yes._generic.caption.font = &uis.freeSansFont;
    s_confirm.yes._generic.caption.color = text_color_normal;
    s_confirm.yes._generic.caption.focuscolor = text_color_highlight;
    
    
    s_confirm.no._generic.type = MTYPE_BITMAP;
    s_confirm.no._generic.name = UI_ART_BUTTON;
    s_confirm.no._generic.flags = QMF_PULSEIFFOCUS;
    s_confirm.no._generic.callback = ConfirmMenu_Event;
    s_confirm.no._generic.id = ID_CONFIRM_NO;
    s_confirm.no._generic.x = 320;
    s_confirm.no._generic.y = 244;
    s_confirm.no.width = 128;
    s_confirm.no.height = 64;
    s_confirm.no.focuspic = UI_ART_BUTTON_FOCUS;
    s_confirm.no._generic.caption.text = "NO";
    s_confirm.no._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    s_confirm.no._generic.caption.fontsize = 0.6f;
    s_confirm.no._generic.caption.font = &uis.freeSansFont;
    s_confirm.no._generic.caption.color = text_color_normal;
    s_confirm.no._generic.caption.focuscolor = text_color_highlight;
...
//  }
    ...
    /*	s_confirm.yes._generic.type = MTYPE_PTEXT;
    	...
    	s_confirm.yes._generic.callback = ConfirmMenu_Event;
    	s_confirm.yes._generic.id = ID_CONFIRM_YES;
    	s_confirm.yes._generic.x = l1;
    	s_confirm.yes._generic.y = 280;
    ...
    */
    ...
    s_confirm.yes._generic.callback = ConfirmMenu_Event;
    s_confirm.yes._generic.id = ID_CONFIRM_YES;
    s_confirm.yes._generic.x = 320 - 64;
    s_confirm.yes._generic.y = 260;
    s_confirm.yes.width = 128;
    s_confirm.yes.height = 64;
    s_confirm.yes.focuspic = UI_ART_BUTTON_FOCUS;
    s_confirm.yes._generic.caption.text = "OK";
    s_confirm.yes._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    s_confirm.yes._generic.caption.fontsize = 0.6f;
    s_confirm.yes._generic.caption.font = &uis.freeSansFont;
    s_confirm.yes._generic.caption.color = text_color_normal;
