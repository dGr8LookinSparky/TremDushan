...
cr_line         credits[] =
{
    {"OpenWolf", UI_CENTER | UI_GIANTFONT, colorWhite},
    ...
    //{"OpenWolf Team", UI_CENTER | UI_BIGFONT, colorLtGrey},
    {"Robert 'Tr3B' Beckebans", UI_CENTER | UI_SMALLFONT, colorWhite},
...
//  {"IOQuake 3 project - www.ioquake3.org", UI_CENTER | UI_SMALLFONT, colorWhite},
    ...
    {"www.sourceforge.net/projects/OpenWolf", UI_CENTER | UI_BIGFONT, colorBlue},
    {"OpenWolf.sourceforge.net", UI_CENTER | UI_BIGFONT, colorBlue},
    {"", UI_CENTER | UI_SMALLFONT, colorBlue},
    
    {"OpenWolf(c) 2005-2009, OpenWolf Team and Contributors", UI_CENTER | UI_SMALLFONT, colorRed},
    ...
    for( n = 0; n <= sizeof( credits ) - 1; n++ )
    {
        ...
        if( credits[n].string == NULL )
        {
            /*
               ...
               if(y < -16)
               {
               // TODO: bring up OpenWolf plaque and fade-in and wait for keypress?
               break;
               }
             */
            break;
        ...
        UI_Text_Paint( x, y, textScale, color, credits[n].string, 0, 0, credits[n].style | UI_DROPSHADOW, &uis.freeSansFont );
