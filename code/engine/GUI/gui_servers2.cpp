...
static char     quake3worldMessage[] = "Visit http://OpenWolf.sourceforge.net - News, Events, Files";
...
static void ArenaServers_UpdatePicture( void )
{
    ...
    {
        g_arenaservers.mappic._generic.name = NULL;
    }
    else
    {
        ...
        g_arenaservers.mappic._generic.name = picname;
...
static void ArenaServers_UpdateMenu( void )
{
    ...
    if( g_arenaservers.numqueriedservers > 0 )
    {
        ...
        else
        {
            ...
            g_arenaservers.master._generic.flags &= ~QMF_GRAYED;
            g_arenaservers.gametype._generic.flags &= ~QMF_GRAYED;
            g_arenaservers.sortkey._generic.flags &= ~QMF_GRAYED;
            g_arenaservers.showempty._generic.flags &= ~QMF_GRAYED;
            g_arenaservers.showfull._generic.flags &= ~QMF_GRAYED;
            g_arenaservers.list._generic.flags &= ~QMF_GRAYED;
            g_arenaservers.refresh._generic.flags &= ~QMF_GRAYED;
            g_arenaservers.go._generic.flags &= ~QMF_GRAYED;
...
int ArenaServers_SetType( int type )
{
    ...
    switch( type )
    {
        default:
        case UIAS_LOCAL:
            g_arenaservers.remove._generic.flags |= ( QMF_INACTIVE | QMF_HIDDEN );
...
static void ArenaServers_MenuInit( void )
{
    ...
    g_arenaservers.banner._generic.type = MTYPE_BTEXT;
    g_arenaservers.banner._generic.flags = QMF_CENTER_JUSTIFY;
    g_arenaservers.banner._generic.x = 320;
    g_arenaservers.banner._generic.y = 16;
    ...
    y = 80;
    g_arenaservers.master._generic.type = MTYPE_SPINCONTROL;
    g_arenaservers.master._generic.name = "Servers:";
    g_arenaservers.master._generic.flags = QMF_PULSEIFFOCUS | QMF_SMALLFONT;
    g_arenaservers.master._generic.callback = ArenaServers_Event;
    g_arenaservers.master._generic.id = ID_MASTER;
    g_arenaservers.master._generic.x = 320;
    g_arenaservers.master._generic.y = y;
    g_arenaservers.master.itemnames = master_items;
    
    y += SMALLCHAR_HEIGHT;
    g_arenaservers.gametype._generic.type = MTYPE_SPINCONTROL;
    g_arenaservers.gametype._generic.name = "Game Type:";
    g_arenaservers.gametype._generic.flags = QMF_PULSEIFFOCUS | QMF_SMALLFONT;
    g_arenaservers.gametype._generic.callback = ArenaServers_Event;
    g_arenaservers.gametype._generic.id = ID_GAMETYPE;
    g_arenaservers.gametype._generic.x = 320;
    g_arenaservers.gametype._generic.y = y;
    g_arenaservers.gametype.itemnames = servertype_items;
    
    y += SMALLCHAR_HEIGHT;
    g_arenaservers.sortkey._generic.type = MTYPE_SPINCONTROL;
    g_arenaservers.sortkey._generic.name = "Sort By:";
    g_arenaservers.sortkey._generic.flags = QMF_PULSEIFFOCUS | QMF_SMALLFONT;
    g_arenaservers.sortkey._generic.callback = ArenaServers_Event;
    g_arenaservers.sortkey._generic.id = ID_SORTKEY;
    g_arenaservers.sortkey._generic.x = 320;
    g_arenaservers.sortkey._generic.y = y;
    g_arenaservers.sortkey.itemnames = sortkey_items;
    
    y += SMALLCHAR_HEIGHT;
    g_arenaservers.showfull._generic.type = MTYPE_RADIOBUTTON;
    g_arenaservers.showfull._generic.name = "Show Full:";
    g_arenaservers.showfull._generic.flags = QMF_PULSEIFFOCUS | QMF_SMALLFONT;
    g_arenaservers.showfull._generic.callback = ArenaServers_Event;
    g_arenaservers.showfull._generic.id = ID_SHOW_FULL;
    g_arenaservers.showfull._generic.x = 320;
    g_arenaservers.showfull._generic.y = y;
    
    y += SMALLCHAR_HEIGHT;
    g_arenaservers.showempty._generic.type = MTYPE_RADIOBUTTON;
    g_arenaservers.showempty._generic.name = "Show Empty:";
    g_arenaservers.showempty._generic.flags = QMF_PULSEIFFOCUS | QMF_SMALLFONT;
    g_arenaservers.showempty._generic.callback = ArenaServers_Event;
    g_arenaservers.showempty._generic.id = ID_SHOW_EMPTY;
    g_arenaservers.showempty._generic.x = 320;
    g_arenaservers.showempty._generic.y = y;
    
    y += 3 * SMALLCHAR_HEIGHT;
    g_arenaservers.list._generic.type = MTYPE_SCROLLLIST;
    g_arenaservers.list._generic.flags = QMF_HIGHLIGHT_IF_FOCUS;
    g_arenaservers.list._generic.id = ID_LIST;
    g_arenaservers.list._generic.callback = ArenaServers_Event;
    g_arenaservers.list._generic.x = 72;
    g_arenaservers.list._generic.y = y;
    ...
    g_arenaservers.mappic._generic.type = MTYPE_BITMAP;
    g_arenaservers.mappic._generic.flags = QMF_LEFT_JUSTIFY | QMF_INACTIVE;
    g_arenaservers.mappic._generic.x = 72;
    g_arenaservers.mappic._generic.y = 80;
    g_arenaservers.mappic.width = 128;
    g_arenaservers.mappic.height = 96;
    g_arenaservers.mappic.errorpic = ART_UNKNOWNMAP;
    
    g_arenaservers.arrows._generic.type = MTYPE_BITMAP;
    g_arenaservers.arrows._generic.name = ART_ARROWS0;
    g_arenaservers.arrows._generic.flags = QMF_LEFT_JUSTIFY | QMF_INACTIVE;
    g_arenaservers.arrows._generic.callback = ArenaServers_Event;
    g_arenaservers.arrows._generic.x = 512 + 48;
    g_arenaservers.arrows._generic.y = 240 - 64 + 16;
    g_arenaservers.arrows.width = 64;
    g_arenaservers.arrows.height = 128;
    
    g_arenaservers.up._generic.type = MTYPE_BITMAP;
    g_arenaservers.up._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS | QMF_MOUSEONLY;
    g_arenaservers.up._generic.callback = ArenaServers_Event;
    g_arenaservers.up._generic.id = ID_SCROLL_UP;
    g_arenaservers.up._generic.x = 512 + 48;
    g_arenaservers.up._generic.y = 240 - 64 + 16;
    g_arenaservers.up.width = 64;
    g_arenaservers.up.height = 64;
    g_arenaservers.up.focuspic = ART_ARROWS_UP;
    
    g_arenaservers.down._generic.type = MTYPE_BITMAP;
    g_arenaservers.down._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS | QMF_MOUSEONLY;
    g_arenaservers.down._generic.callback = ArenaServers_Event;
    g_arenaservers.down._generic.id = ID_SCROLL_DOWN;
    g_arenaservers.down._generic.x = 512 + 48;
    g_arenaservers.down._generic.y = 240 + 16;
    g_arenaservers.down.width = 64;
    g_arenaservers.down.height = 64;
    g_arenaservers.down.focuspic = ART_ARROWS_DOWN;
    
    y = 376;
    g_arenaservers.status._generic.type = MTYPE_TEXT;
    g_arenaservers.status._generic.x = 320;
    g_arenaservers.status._generic.y = y;
    ...
    y += SMALLCHAR_HEIGHT;
    g_arenaservers.statusbar._generic.type = MTYPE_TEXT;
    g_arenaservers.statusbar._generic.x = 320;
    g_arenaservers.statusbar._generic.y = y;
    g_arenaservers.statusbar.string = "";
    g_arenaservers.statusbar.style = UI_CENTER | UI_SMALLFONT;
    g_arenaservers.statusbar.color = text_color_normal;
    
    g_arenaservers.remove._generic.type = MTYPE_BITMAP;
    g_arenaservers.remove._generic.name = UI_ART_BUTTON;
    g_arenaservers.remove._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    g_arenaservers.remove._generic.callback = ArenaServers_Event;
    g_arenaservers.remove._generic.id = ID_REMOVE;
    g_arenaservers.remove._generic.x = 450;
    g_arenaservers.remove._generic.y = 86;
    g_arenaservers.remove.width = 128;
    g_arenaservers.remove.height = 64;
    g_arenaservers.remove.focuspic = UI_ART_BUTTON_FOCUS;
    g_arenaservers.remove._generic.caption.text = "remove";
    g_arenaservers.remove._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    g_arenaservers.remove._generic.caption.fontsize = 0.6f;
    g_arenaservers.remove._generic.caption.font = &uis.freeSansFont;
    g_arenaservers.remove._generic.caption.color = text_color_normal;
    g_arenaservers.remove._generic.caption.focuscolor = text_color_highlight;
    
    
    g_arenaservers.back._generic.type = MTYPE_BITMAP;
    g_arenaservers.back._generic.name = UI_ART_BUTTON;
    g_arenaservers.back._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    g_arenaservers.back._generic.callback = ArenaServers_Event;
    g_arenaservers.back._generic.id = ID_BACK;
    g_arenaservers.back._generic.x = 0;
    g_arenaservers.back._generic.y = 480 - 64;
    g_arenaservers.back.width = 128;
    g_arenaservers.back.height = 64;
    g_arenaservers.back.focuspic = UI_ART_BUTTON_FOCUS;
    g_arenaservers.back._generic.caption.text = "back";
    g_arenaservers.back._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    g_arenaservers.back._generic.caption.fontsize = 0.6f;
    g_arenaservers.back._generic.caption.font = &uis.freeSansFont;
    g_arenaservers.back._generic.caption.color = text_color_normal;
    g_arenaservers.back._generic.caption.focuscolor = text_color_highlight;
    
    g_arenaservers.specify._generic.type = MTYPE_BITMAP;
    g_arenaservers.specify._generic.name = UI_ART_BUTTON;
    g_arenaservers.specify._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    g_arenaservers.specify._generic.callback = ArenaServers_Event;
    g_arenaservers.specify._generic.id = ID_SPECIFY;
    g_arenaservers.specify._generic.x = 128;
    g_arenaservers.specify._generic.y = 480 - 64;
    g_arenaservers.specify.width = 128;
    g_arenaservers.specify.height = 64;
    g_arenaservers.specify.focuspic = UI_ART_BUTTON_FOCUS;
    g_arenaservers.specify._generic.caption.text = "specify";
    g_arenaservers.specify._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    g_arenaservers.specify._generic.caption.fontsize = 0.6f;
    g_arenaservers.specify._generic.caption.font = &uis.freeSansFont;
    g_arenaservers.specify._generic.caption.color = text_color_normal;
    g_arenaservers.specify._generic.caption.focuscolor = text_color_highlight;
    
    g_arenaservers.refresh._generic.type = MTYPE_BITMAP;
    g_arenaservers.refresh._generic.name = UI_ART_BUTTON;
    g_arenaservers.refresh._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    g_arenaservers.refresh._generic.callback = ArenaServers_Event;
    g_arenaservers.refresh._generic.id = ID_REFRESH;
    g_arenaservers.refresh._generic.x = 256;
    g_arenaservers.refresh._generic.y = 480 - 64;
    g_arenaservers.refresh.width = 128;
    g_arenaservers.refresh.height = 64;
    g_arenaservers.refresh.focuspic = UI_ART_BUTTON_FOCUS;
    g_arenaservers.refresh._generic.caption.text = "refresh";
    g_arenaservers.refresh._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    g_arenaservers.refresh._generic.caption.fontsize = 0.6f;
    g_arenaservers.refresh._generic.caption.font = &uis.freeSansFont;
    g_arenaservers.refresh._generic.caption.color = text_color_normal;
    g_arenaservers.refresh._generic.caption.focuscolor = text_color_highlight;
    
    g_arenaservers.create._generic.type = MTYPE_BITMAP;
    g_arenaservers.create._generic.name = UI_ART_BUTTON;
    g_arenaservers.create._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    g_arenaservers.create._generic.callback = ArenaServers_Event;
    g_arenaservers.create._generic.id = ID_CREATE;
    g_arenaservers.create._generic.x = 384;
    g_arenaservers.create._generic.y = 480 - 64;
    g_arenaservers.create.width = 128;
    g_arenaservers.create.height = 64;
    g_arenaservers.create.focuspic = UI_ART_BUTTON_FOCUS;
    g_arenaservers.create._generic.caption.text = "host";
    g_arenaservers.create._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    g_arenaservers.create._generic.caption.fontsize = 0.6f;
    g_arenaservers.create._generic.caption.font = &uis.freeSansFont;
    g_arenaservers.create._generic.caption.color = text_color_normal;
    g_arenaservers.create._generic.caption.focuscolor = text_color_highlight;
    
    g_arenaservers.go._generic.type = MTYPE_BITMAP;
    g_arenaservers.go._generic.name = UI_ART_BUTTON;
    g_arenaservers.go._generic.flags = QMF_RIGHT_JUSTIFY | QMF_PULSEIFFOCUS;
    g_arenaservers.go._generic.callback = ArenaServers_Event;
    g_arenaservers.go._generic.id = ID_CONNECT;
    g_arenaservers.go._generic.x = 640;
    g_arenaservers.go._generic.y = 480 - 64;
    g_arenaservers.go.width = 128;
    g_arenaservers.go.height = 64;
    g_arenaservers.go.focuspic = UI_ART_BUTTON_FOCUS;
    g_arenaservers.go._generic.caption.text = "connect";
    g_arenaservers.go._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    g_arenaservers.go._generic.caption.fontsize = 0.6f;
    g_arenaservers.go._generic.caption.font = &uis.freeSansFont;
    g_arenaservers.go._generic.caption.color = text_color_normal;
    g_arenaservers.go._generic.caption.focuscolor = text_color_highlight;
