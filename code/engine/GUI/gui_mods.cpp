...
static void UI_Mods_LoadMods( void )
{
    ...
    s_mods.list.itemnames[0] = s_mods.descriptionList[0] = "OpenWolf";
...
static void UI_Mods_MenuInit( void )
{
    ...
    s_mods.banner._generic.type = MTYPE_BTEXT;
    s_mods.banner._generic.x = 320;
    s_mods.banner._generic.y = 16;
    s_mods.banner.string = "MODS";
    s_mods.banner.color = color_white;
    s_mods.banner.style = UI_CENTER | UI_DROPSHADOW;
    
    /*	s_mods.framel._generic.type = MTYPE_BITMAP;
    	s_mods.framel._generic.name = ART_FRAMEL;
    	s_mods.framel._generic.flags = QMF_INACTIVE;
    	s_mods.framel._generic.x = 0;
    	s_mods.framel._generic.y = 78;
    	s_mods.framel.width = 256;
    	s_mods.framel.height = 329;
    
    	s_mods.framer._generic.type = MTYPE_BITMAP;
    	s_mods.framer._generic.name = ART_FRAMER;
    	s_mods.framer._generic.flags = QMF_INACTIVE;
    	s_mods.framer._generic.x = 376;
    	s_mods.framer._generic.y = 76;
    	s_mods.framer.width = 256;
    	s_mods.framer.height = 334;
    */
    s_mods.back._generic.type = MTYPE_BITMAP;
    s_mods.back._generic.name = UI_ART_BUTTON;
    s_mods.back._generic.flags = QMF_LEFT_JUSTIFY | QMF_PULSEIFFOCUS;
    s_mods.back._generic.id = ID_BACK;
    s_mods.back._generic.callback = UI_Mods_MenuEvent;
    s_mods.back._generic.x = 0;
    s_mods.back._generic.y = 480 - 64;
    s_mods.back.width = 128;
    s_mods.back.height = 64;
    s_mods.back.focuspic = UI_ART_BUTTON_FOCUS;
    s_mods.back._generic.caption.text = "back";
    s_mods.back._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    s_mods.back._generic.caption.fontsize = 0.6f;
    s_mods.back._generic.caption.font = &uis.freeSansFont;
    s_mods.back._generic.caption.color = text_color_normal;
    s_mods.back._generic.caption.focuscolor = text_color_highlight;
    
    s_mods.go._generic.type = MTYPE_BITMAP;
    s_mods.go._generic.name = UI_ART_BUTTON;
    s_mods.go._generic.flags = QMF_RIGHT_JUSTIFY | QMF_PULSEIFFOCUS;
    s_mods.go._generic.id = ID_GO;
    s_mods.go._generic.callback = UI_Mods_MenuEvent;
    s_mods.go._generic.x = 640;
    s_mods.go._generic.y = 480 - 64;
    s_mods.go.width = 128;
    s_mods.go.height = 64;
    s_mods.go.focuspic = UI_ART_BUTTON_FOCUS;
    s_mods.go._generic.caption.text = "load";
    s_mods.go._generic.caption.style = UI_CENTER | UI_DROPSHADOW;
    s_mods.go._generic.caption.fontsize = 0.6f;
    s_mods.go._generic.caption.font = &uis.freeSansFont;
    s_mods.go._generic.caption.color = text_color_normal;
    s_mods.go._generic.caption.focuscolor = text_color_highlight;
    
    // scan for mods
    s_mods.list._generic.type = MTYPE_SCROLLLIST;
    s_mods.list._generic.flags = QMF_PULSEIFFOCUS | QMF_CENTER_JUSTIFY;
    s_mods.list._generic.callback = UI_Mods_MenuEvent;
    s_mods.list._generic.id = ID_LIST;
    s_mods.list._generic.x = 320;
    s_mods.list._generic.y = 130;
