...
intptr_t CL_CgameSystemCalls( intptr_t* args )
{
    switch( args[0] )
    {
        ...
        case CG_ADDCOMMANDALIAS:
            CL_AddCgameCommandAlias( ( const char* )VMA( 1 ), ( const char* )VMA( 2 ) );
            return 0;
        ...
        case CG_CM_BOXTRACE:
            CM_BoxTrace( ( trace_t* )VMA( 1 ), ( const vec_t* )VMA( 2 ), ( const vec_t* )VMA( 3 ), ( vec_t* )VMA( 4 ), ( vec_t* )VMA( 5 ), args[6], args[7], TT_AABB );
            return 0;
        case CG_CM_CAPSULETRACE:
            CM_BoxTrace( ( trace_t* )VMA( 1 ), ( const vec_t* )VMA( 2 ), ( const vec_t* )VMA( 3 ), ( vec_t* )VMA( 4 ), ( vec_t* )VMA( 5 ), args[6], args[7], TT_CAPSULE );
            return 0;
        case CG_CM_TRANSFORMEDBOXTRACE:
            CM_TransformedBoxTrace( ( trace_t* )VMA( 1 ), ( const vec_t* )VMA( 2 ), ( const vec_t* )VMA( 3 ), ( vec_t* )VMA( 4 ), ( vec_t* )VMA( 5 ), args[6], args[7], ( const vec_t* )VMA( 8 ), ( const vec_t* )VMA( 9 ), TT_AABB );
            return 0;
        case CG_CM_TRANSFORMEDCAPSULETRACE:
            CM_TransformedBoxTrace( ( trace_t* )VMA( 1 ), ( const vec_t* )VMA( 2 ), ( const vec_t* )VMA( 3 ), ( vec_t* )VMA( 4 ), ( vec_t* )VMA( 5 ), args[6], args[7], ( const vec_t* )VMA( 8 ), ( const vec_t* )VMA( 9 ), TT_CAPSULE );
            return 0;
        ...
        case CG_R_REGISTERSHADERLIGHTATTENUATION:
            return re.RegisterShaderLightAttenuation( ( const char* )VMA( 1 ) );
