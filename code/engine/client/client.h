...
#if defined(USE_JAVA)
void			Java_CG_KeyEvent( int key, bool down );
...
void			Java_UI_KeyEvent( int key, bool down );
void			Java_UI_MouseEvent( int dx, int dy );
void			Java_UI_Refresh( int time );
bool		Java_UI_IsFullscreen( void );
void			Java_UI_SetActiveMenu( uiMenuCommand_t menu );
void			Java_UI_DrawConnectScreen( bool overlay );
bool		Java_UI_ConsoleCommand( int realTime );
#endif
