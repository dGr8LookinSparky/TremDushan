...
intptr_t CL_UISystemCalls( intptr_t* args )
{
    switch( args[0] )
    {
        ...
        case UI_CMD_EXECUTETEXT:
            if( args[1] == 0
                    && ( !strncmp( ( const char* )VMA( 2 ), "snd_restart", 11 ) || !strncmp( ( const char* )VMA( 2 ), "vid_restart", 11 ) || !strncmp( ( const char* )VMA( 2 ), "quit", 5 ) ) )
            {
...
void CL_InitUI( void )
{
    ...
    {
//      Com_Printf(S_COLOR_YELLOW "WARNING: loading old OpenWolf User Interface version %d\n", v );
