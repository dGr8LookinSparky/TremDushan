...
void Con_DrawInput( vec4_t color )
{
    ...
    Field_Draw( &g_consoleField, 26, 234, SCREEN_WIDTH - 3 * SMALLCHAR_WIDTH, true, true );
}
...
void Con_DrawNotify( void )
{
    ...
    if( Key_GetCatcher() & KEYCATCH_MESSAGE )
    {
        ...
        Field_BigDraw( &chatField, skip, v + SCR_Text_Height( s, 0.25f, 0, &cls.consoleFont ) / 2, SCREEN_WIDTH - ( skip + 1 ), true,
                       true );
