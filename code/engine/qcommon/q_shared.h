...
#define PRODUCT_NAME            "Tremulous" // Case, Spaces allowed
...
// RB: OpenWolf matrix math functions required by the renderer
...
// RB: OpenWolf quaternion math functions required by the renderer
...
bool        Com_CheckColorCodes( const char* s );
