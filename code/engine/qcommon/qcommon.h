...
#define MASTER_SERVER_NAME		"master.OpenWolf-project.net"
#endif
...
#ifdef DEDICATED
#	define Q3CONFIG_CFG "tremulous_server.cfg"
#else
#	define Q3CONFIG_CFG "tremulous.cfg"
#endif
...
void            Field_CompleteFilename( const char* dir, const char* ext, bool stripExt );
