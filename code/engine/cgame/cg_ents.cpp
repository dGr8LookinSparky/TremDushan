...
======================
*/
bool CG_PositionRotatedEntityOnBone( refEntity_t* entity, const refEntity_t* parent, qhandle_t parentModel, char* tagName )
{
    int             i;
    int             boneIndex;
    orientation_t   lerped;
...
==================
*/
static void CG_AI( centity_t* cent )
{
    refEntity_t     ent;
    entityState_t*  s1;
    ...
    */
    ...
    ent.hModel = cgs.gameModels[s1->modelindex];
    ent.customShader = cgs.media.debugWorld;
