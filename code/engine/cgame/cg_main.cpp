...
vmCvar_t        cg_recastDebug;
vmCvar_t        cg_detourDebug;
vmCvar_t 		cg_waypointDebug;
vmCvar_t 		cg_coverDebug;
...
static cvarTable_t cvarTable[] =  	// bk001129
{
    ...
    {&cg_drawStatus, "cg_drawStatus", "2", CVAR_CHEAT},
    ...
    // recast debug
    {&cg_recastDebug, "cg_recastDebug", "0", CVAR_ARCHIVE},
    {&cg_detourDebug, "cg_detourDebug", "0", CVAR_ARCHIVE},
    {&cg_waypointDebug, "cg_waypointDebug", "0", CVAR_ARCHIVE},
    {&cg_coverDebug, "cg_coverDebug", "1", CVAR_ARCHIVE},
...
static void CG_RegisterSounds( void )
{
    ...
    CG_LoadVoiceChats();
#endif
    CG_LoadingString( "feedback", false );
    ...
    CG_LoadingString( "team sounds", false );
    ...
    CG_LoadingString( "weapon sounds", false );
    ...
    CG_LoadingString( "ambient sounds", false );
    ...
    CG_LoadingString( "medal sounds", false );
    ...
    CG_LoadingString( "footsteps", false );
    ...
    CG_LoadingString( "item sounds", false );
...
//      }
    ...
    CG_LoadingString( "misc sounds", false );
...
static void CG_RegisterGraphics( void )
{
    ...
    CG_LoadingString( cgs.mapname, false );
    
    trap_R_LoadWorldMap( cgs.mapname );
    
    CG_LoadingString( "precaching", false );
    ...
    CG_LoadingString( "interface", false );
    ...
    CG_LoadingString( "rankings", false );
    ...
    CG_LoadingString( "effects", false );
    ...
    CG_LoadingString( "visuals", false );
    ...
    CG_LoadingString( "notifications", false );
    ...
    CG_LoadingString( "powerups", false );
    ...
    CG_LoadingString( "icons", false );
    
    if( cgs.gametype == GT_CTF || cgs.gametype == GT_1FCTF || cgs.gametype == GT_HARVESTER )
    {
        cgs.media.flagModel = trap_R_RegisterModel( "models/flags/flag.md5mesh" );
        CG_RegisterAnimation( &cgs.media.flagAnimations[FLAG_IDLE], "models/flags/flag_idle.md5anim", true, false, true );
        CG_RegisterAnimation( &cgs.media.flagAnimations[FLAG_RUN], "models/flags/flag_run.md5anim", true, false, true );
    ...
    CG_LoadingString( "model icons", false );
    ...
    cgs.media.debugWorld = trap_R_RegisterShader( "debugWorld" );
    
    CG_LoadingString( "debris effects", false );
    ...
    CG_LoadingString( "particles", false );
...
static void CG_RegisterClients( void )
{
    ...
    for( i = 0; i < MAX_CLIENTS; i++ )
    {
        ...
        CG_LoadingString( va( "precaching %i", i ), false );
...
void CG_Init( int serverMessageNum, int serverCommandSequence, int clientNum )
{
    ...
    trap_R_RegisterFont( "gfx/fonts/FreeSans.ttf", 48, &cgs.media.freeSansFont );
    ...
    // load the new map
    CG_LoadingString( "...", false );
    
    trap_CM_LoadMap( cgs.mapname );
    
    cg.loading = true;			// force players to load instead of defer
    
    CG_LoadingString( "sounds", true );
    
    CG_RegisterSounds();
    
    CG_LoadingString( "graphics", true );
    
    CG_RegisterGraphics();
    
    CG_LoadingString( "clients", true );
    
    CG_RegisterClients();		// if low on memory, some clients will be deferred
    
    CG_LoadingString( "osd", true );
    
    CG_RegisterOSD();
    
    cg.loading = false;		// future players will be deferred
    
    CG_LoadingString( "entities", true );
    
    CG_InitLocalEntities();
    
    CG_LoadingString( "polys", true );
