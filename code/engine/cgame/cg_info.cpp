...
static void CG_DrawProgress( void )
{
    ...
    if( cg.progress == 0 )
    {
        CG_Text_PaintAligned( 230, 228, "Precaching ... ", 0.3f, UI_RIGHT | UI_DROPSHADOW, colorText, &cgs.media.freeSansFont );
        
    }
    else
    {
        CG_Text_PaintAligned( 230, 228, "Loading ", 0.3f, UI_RIGHT | UI_DROPSHADOW, colorText, &cgs.media.freeSansFont );
    ...
    for( i = 0; i < cg.progress; i++ )
    {
        ...
        CG_Text_PaintAligned( 20, 440 - i * 12, cg.progressInfo[i].info, 0.2f, style, color, &cgs.media.freeSansFont );
        ...
        if( i == cg.progress - 1 )
        {
            ...
            CG_Text_PaintAligned( x + i * 16 + 8, y - 8, cg.progressInfo[i].info, 0.2f, UI_RIGHT | UI_DROPSHADOW,
                                  text_color_highlight, &cgs.media.freeSansFont );
