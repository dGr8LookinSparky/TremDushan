...
typedef struct
{
    ...
    navMeshDataInfo_t     nv_info;
    
    unsigned short*     nv_verts;
    unsigned short*     nv_polys;
    unsigned short*     nv_flags;
    unsigned char*      nv_areas;
    int     nv_nverts;
    int     nv_npolys;
    int     nv_nvp;
    
    unsigned int*       nv_dmeshes;
    float*              nv_dverts;
    unsigned char*      nv_dtris;
    int     nv_ndmeshes;
    int     nv_ndverts;
    int     nv_ndtris;
    ...
    // waypoints
    waypoint_t nv_waypoints[WAYPOINT_MAX];
    int nv_nwaypoints;
    
    // cover point testing
    cover_t nv_covers[COVER_MAX];
    int nv_ncovers;
    
    // cover plate testing
    cplate_t nv_pcovers[COVER_PLATES_MAX];
    int nv_npcovers;
...
extern vmCvar_t cg_recastDebug;
extern vmCvar_t cg_detourDebug;
extern vmCvar_t cg_waypointDebug;
extern vmCvar_t cg_coverDebug;
...
// cg_animation.c
//
bool        CG_RegisterAnimation( animation_t* anim, const char* filename,
...
void CG_DebugDrawVert4( polyVert_t verts[3], vec4_t color );
...
bool        CG_PositionRotatedEntityOnBone( refEntity_t* entity, const refEntity_t* parent,
        qhandle_t parentModel, char* tagName );
...
void            CG_ImpactMark( qhandle_t markShader,
                               ...
                               float orientation,
                               float r, float g, float b, float a, bool alphaFade, float radius, bool temporary );
...
// cg_info.c
//
void            CG_LoadingString( const char* s, bool strong );
