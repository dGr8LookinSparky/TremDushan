...
/*
================
CG_DrawStatusBarOpenWolf
================
*/


static void CG_DrawStatusBarOpenWolf( void )
{
    /*	int             color;
    	centity_t      *cent;
    	playerState_t  *ps;
...
{
    CG_Text_PaintAligned( x, y, s, size, style | UI_DROPSHADOW, color, &cgs.media.freeSansFont );
}
...
static float CG_DrawSnapshot( float y )
{
    ...
    CG_Text_PaintAligned( 635, y + 4, s, 0.2f, UI_RIGHT | UI_DROPSHADOW, colorWhite, &cgs.media.freeSansFont );
...
static float CG_DrawFPS( float y )
{
    ...
    if( index > FPS_FRAMES )
    {
        ...
        CG_Text_PaintAligned( 635, y, s, 0.25f, UI_RIGHT | UI_DROPSHADOW, colorWhite, &cgs.media.freeSansFont );
    }
    ...
    for( i = 0; i < count; i++ )
    {
        ...
        if( ci->infoValid && ci->team == cg.snap->ps.persistant[PERS_TEAM] )
        {
            ...
            CG_DrawStringExt( xx, y,
                              ci->name, hcolor, false, false, TINYCHAR_WIDTH, TINYCHAR_HEIGHT, TEAM_OVERLAY_MAXNAME_WIDTH );
            ...
            if( lwidth )
            {
                ...
                CG_DrawStringExt( xx, y,
                                  p, hcolor, false, false, TINYCHAR_WIDTH, TINYCHAR_HEIGHT, TEAM_OVERLAY_MAXLOCATION_WIDTH );
            }
            ...
            CG_DrawStringExt( xx, y, st, hcolor, false, false, TINYCHAR_WIDTH, TINYCHAR_HEIGHT, 0 );
    ...
    if( value )
    {
        ...
        if( fadeColor )
        {
            ...
            CG_Text_PaintAligned( ICON_SIZE + 16, y + ( ICON_SIZE / 2 ), bg_itemlist[value].pickup_name, 0.4f,
                                  UI_LEFT | UI_DROPSHADOW, fadeColor, &cgs.media.freeSansFont );
            trap_R_SetColor( NULL );
        }
    }
    ...
    if( cgs.teamLastChatPos != cgs.teamChatPos )
    {
        ...
        for( i = cgs.teamChatPos - 1; i >= cgs.teamLastChatPos; i-- )
        {
            CG_DrawStringExt( CHATLOC_X + TINYCHAR_WIDTH,
                              ...
                              cgs.teamChatMsgs[i % chatHeight], hcolor, false, false, TINYCHAR_WIDTH, TINYCHAR_HEIGHT, 0 );
        }
    }
}
...
static void CG_DrawDisconnect( void )
{
    ...
    w = CG_Text_Width( s, 0.5f, 0, &cgs.media.freeSansFont );
    CG_Text_Paint( 320 - w / 2, 100, 0.5f, colorRed, s, 0, 0, UI_DROPSHADOW, &cgs.media.freeSansFont );
...
static void CG_DrawLagometer( void )
{
    ...
    */
    ...
    {
        CG_Text_Paint( ax, ay, 0.4f, colorRed, "snc", 0, 0, UI_CENTER | UI_DROPSHADOW, &cgs.media.freeSansFont );
    }
...
static void CG_DrawCenterString( void )
{
    ...
    while( 1 )
    {
        ...
        w = CG_Text_Width( linebuffer, 0.4f, 0, &cgs.media.freeSansFont );
        h = CG_Text_Height( linebuffer, 0.4f, 0, &cgs.media.freeSansFont );
        x = ( SCREEN_WIDTH - w ) / 2;
        CG_Text_Paint( x, y + h, 0.4f, color, linebuffer, 0, 0, UI_CENTER | UI_DROPSHADOW, &cgs.media.freeSansFont );
        y += h + 6;
...
static void CG_DrawCrosshairNames( void )
{
    ...
    if( cg_drawStatus.integer == 3 )
    {
        ...
        color[3] *= 0.85f;
        w = CG_Text_Width( name, 0.2f, 0, &cgs.media.freeSansFont );
        CG_Text_Paint( 320 - w / 2, 265, 0.2f, color, name, 0, 0, 0, &cgs.media.freeSansFont );
    ...
    color[3] *= 0.5f;
    w = CG_Text_Width( name, 0.3f, 0, &cgs.media.freeSansFont );
    CG_Text_Paint( 320 - w / 2, 190, 0.3f, color, name, 0, 0, UI_DROPSHADOW, &cgs.media.freeSansFont );
...
{
    CG_Text_PaintAligned( 320, 440, "SPECTATOR", 0.45f, UI_CENTER | UI_DROPSHADOW, colorWhite, &cgs.media.freeSansFont );
...
static bool CG_DrawFollow( void )
{
    ...
    CG_Text_PaintAligned( 320, 64, "following", 0.35f, UI_CENTER | UI_DROPSHADOW, colorWhite, &cgs.media.freeSansFont );
    
    name = cgs.clientinfo[cg.snap->ps.clientNum].name;
    CG_Text_PaintAligned( 320, 90, name, 0.45f, UI_CENTER | UI_DROPSHADOW, colorWhite, &cgs.media.freeSansFont );
...
static void CG_DrawAmmoWarning( void )
{
    ...
    {
        CG_Text_PaintAligned( 320, 400, "out of ammo", 0.4f, UI_CENTER | UI_DROPSHADOW, colorRed, &cgs.media.freeSansFont );
    }
    else
    {
    
        CG_Text_PaintAligned( 320, 400, "ammo low", 0.4f, UI_CENTER | UI_DROPSHADOW, colorYellow, &cgs.media.freeSansFont );
    }
}
...
static void CG_DrawWarmup( void )
{
    ...
    if( sec < 0 )
    {
        ...
        CG_Text_PaintAligned( 320, 64, s, 0.25f, UI_CENTER | UI_DROPSHADOW, colorWhite, &cgs.media.freeSansFont );
        cg.warmupCount = 0;
        return;
    }
    ...
    if( cgs.gametype == GT_TOURNAMENT )
    {
        ...
        if( ci1 && ci2 )
        {
            ...
            CG_Text_PaintAligned( 320, 64, s, 0.4f, UI_CENTER | UI_DROPSHADOW, colorWhite, &cgs.media.freeSansFont );
        }
    }
    else
    {
        ...
        CG_Text_PaintAligned( 320, 90, s, 0.4f, UI_CENTER | UI_DROPSHADOW, colorWhite, &cgs.media.freeSansFont );
    }
    ...
    CG_Text_PaintAligned( 320, 125, s, scale, UI_CENTER | UI_DROPSHADOW, colorWhite, &cgs.media.freeSansFont );
}
...
static int debugModel( int x, int y )
{
    ...
    CG_Text_Paint( x, y, 0.2f, colorRed, "Model:", 0.0f, 0, 0, &cgs.media.freeSansFont );
    y += 10;
    
    CG_Text_Paint( x + 10, y, 0.15f, colorYellow, va( "current anim: %i", debug_anim_current ), 0.0f, 0, 0, &cgs.media.freeSansFont );
    y += 8;
    CG_Text_Paint( x + 10, y, 0.15f, colorYellow, va( "old anim: %i", debug_anim_old ), 0.0f, 0, 0, &cgs.media.freeSansFont );
    y += 8;
    CG_Text_Paint( x + 10, y, 0.15f, colorYellow, va( "anim blend : %f", debug_anim_blend ), 0.0f, 0, 0, &cgs.media.freeSansFont );
    y += 8;
...
static int debugSystem( int x, int y )
{
    ...
    CG_Text_Paint( x, y, 0.2f, colorRed, "System:", 0.0f, 0, 0, &cgs.media.freeSansFont );
    y += 10;
    ...
    if( index > FPS_FRAMES )
    {
        ...
        CG_Text_Paint( x + 10, y, 0.15f, colorYellow, s, 0.0f, 0, 0, &cgs.media.freeSansFont );
        y += 8;
