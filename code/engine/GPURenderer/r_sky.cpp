...
void RB_DrawSun( void )
{
    ...
    GLSL_SetUniform_InverseVertexColor( &tr.genericShader,  false );
    ...
    Tess_Begin( Tess_StageIteratorGeneric, tr.sunShader, NULL, tess.skipTangentSpaces, false, -1, tess.fogNum );
