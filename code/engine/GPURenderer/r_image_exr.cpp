...
void LoadRGBEToFloats( const char* name, float** pic, int* width, int* height, bool doGamma, bool toneMap, bool compensate );
...
#else
    w = h = 0;
    LoadRGBEToFloats( name, &hdrImage, &w, &h, true, false, true );
