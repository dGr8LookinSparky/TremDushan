...
bool R_LoadMDC( model_t* mod, int lod, void* buffer, int bufferSize, const char* name );
bool R_LoadMDM( model_t* mod, void* buffer, const char* name );
static bool R_LoadMDX( model_t* mod, void* buffer, const char* name );
#endif
...
*/
#if defined(COMPAT_ET)
static bool R_LoadMDX( model_t* mod, void* buffer, const char* mod_name )
{
    int             i, j;
...
*/
/*
static bool R_LoadDAE(model_t * mod, void *buffer, int bufferLen, const char *modName)
{
	xmlDocPtr       doc;
	xmlNodePtr      node;
