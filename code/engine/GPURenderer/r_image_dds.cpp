...
image_t*        R_LoadDDSImageData( void* pImageData, const char* name, int bits, filterType_t filterType, wrapType_t wrapType )
{
    ...
    */
    ...
    usingAlpha = ( ddsd->u4.ddpfPixelFormat.dwFlags & DDPF_ALPHAPIXELS ) ? true : false;
    ...
    compressed = ( ddsd->u4.ddpfPixelFormat.dwFlags & DDPF_FOURCC ) ? true : false;
