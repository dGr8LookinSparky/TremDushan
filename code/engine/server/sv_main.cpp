...
#define	HEARTBEAT_GAME	"OpenWolf-1"
...
void SV_Frame( int msec )
{
    ...
    if( !com_dedicated->integer )
    {
        ...
        SV_AIFrame( sv.time + sv.timeResidual ); // AI will run alongside the default bots
    }
    ...
    {
        SV_BotFrame( sv.time );
        SV_AIFrame( sv.time ); // AI will run alongside the default bots
    }
