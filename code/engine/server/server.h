...
#if defined(USE_JAVA)
void			Java_G_InitGame( int levelTime, int randomSeed, bool restart );
void			Java_G_ShutdownGame( bool restart );
char*           Java_G_ClientConnect( int clientNum, bool firstTime, bool isBot );
...
bool		Java_G_ConsoleCommand( void );
#endif
...
void            SV_AIFrame( int time ); // AI will run alongside the default bots
